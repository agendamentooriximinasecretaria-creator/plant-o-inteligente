...
const emptyForm = { unidade_id: '', setor_id: '', profissao: 'medico', profissional_id: '', data: '', hora_inicio: '07:00', hora_fim: '19:00', tipo_plantao: 'Diurno 12h', observacoes: '', status: 'agendado' as const };
